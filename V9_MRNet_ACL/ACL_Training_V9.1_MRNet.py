# ============================================================
# ACL Tear Detection — V9.1 MRNet (Anti-Overfit)
# ============================================================
...
SAVE_PATH = '/content/drive/MyDrive/dataset/best_acl_model_v9.1.pth'
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/dataset/training_history_v9.1.png', dpi=150)
plt.show()
...
print('\n' + '=' * 60)
print('RESULTS — V9.1 (Anti-Overfit)')
print('=' * 60)
...
plt.title(f'Confusion Matrix — V9.1 (threshold={best_threshold:.3f})')
plt.savefig('/content/drive/MyDrive/dataset/confusion_matrix_v9.1.png', dpi=150)
plt.show()
